  ...
  return (
    <main className="grid min-h-dvh place-items-center bg-neutral-50 px-5 dark:bg-neutral-950">
      <section className="w-full max-w-md rounded-3xl border border-neutral-200 bg-white p-7 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
        ...
        <AsyncActionForm action={signUpAction} className="mt-7 space-y-4">
          ...
          <PendingActionButton className="min-h-11 w-full rounded-xl bg-neutral-950 px-4 text-sm font-semibold text-white disabled:opacity-60 dark:bg-white dark:text-neutral-950" pendingLabel="Creating account…" successLabel="Done" errorLabel="Try again">
            Create account
          </PendingActionButton>
        </AsyncActionForm>
