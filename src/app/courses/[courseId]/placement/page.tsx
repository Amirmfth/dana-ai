    ...
    return (
      <main className="min-h-dvh bg-neutral-50 px-5 py-10 text-neutral-950 dark:bg-neutral-950 dark:text-neutral-50">
        <div className="mx-auto max-w-2xl">
          ...
          <h1 className="mt-5 text-3xl font-semibold">Placement is disabled</h1>
          <p className="mt-3 text-neutral-600 dark:text-neutral-300">Flexible courses unlock every lesson immediately and do not use placement assessments.</p>
        </div>
      </main>
    );
  }
