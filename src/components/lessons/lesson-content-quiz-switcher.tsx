      ...
      <div
        ...
        className={[
          ...
          activeView === "quiz" && !isFocusMode
            ? "lg:visible lg:static lg:block lg:max-h-none lg:translate-y-0 lg:overflow-visible lg:rounded-none lg:border-0 lg:bg-transparent lg:shadow-none lg:pointer-events-auto"
            : "lg:hidden",
        ].join(" ")}
      >
